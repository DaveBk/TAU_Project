...
public class SeleniumTests {
    ...
    public void testRegisterForm() throws InterruptedException {
        ...
        Thread.sleep(500);
        driver.findElement(By.xpath("//*[@id=\"header\"]/div[2]/div/div/nav/div[1]/a")).click();
        driver.findElement(By.xpath("//*[@id=\"email_create\"]")).sendKeys("asdkdajdsad@sadsadasd.pl");
        driver.findElement(By.xpath("//*[@id=\"SubmitCreate\"]")).click();
        Thread.sleep(1500);

        driver.findElement(By.xpath("//*[@id=\"id_gender1\"]")).click();
        driver.findElement(By.xpath("//*[@id=\"customer_firstname\"]")).sendKeys("Dawid");
        driver.findElement(By.xpath("//*[@id=\"customer_lastname\"]")).sendKeys("Kosmonauta");
        ...
        driver.findElement(By.xpath("//*[@id=\"firstname\"]")).sendKeys("Dawid");
        driver.findElement(By.xpath("//*[@id=\"lastname\"]")).sendKeys("Kosmonauta");
        ...
        driver.findElement(By.xpath("//*[@id=\"postcode\"]")).sendKeys("00009");

        driver.findElement(By.xpath("//*[@id=\"phone_mobile\"]")).sendKeys("600876983");

        driver.findElement(By.xpath("//*[@id=\"submitAccount\"]")).click();

        Assert.assertEquals(driver.findElement(By.xpath("//*[@id=\"header\"]/div[2]/div/div/nav/div[1]/a/span")).getText(), "Dawid Kosmonauta");
    }
